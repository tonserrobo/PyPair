...
def main():
    ...
    if training_flag:
        ...
        training_data = training_data_obj.generate_training_data(training_iterations, seed_length, read_length) #will gen index if does not already exsist
        df = training_data
